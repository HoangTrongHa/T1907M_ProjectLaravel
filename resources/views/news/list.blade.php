...
{{--            <thead>--}}
{{--            <tr>--}}
{{--                <th style="text-align: center">new_title</th>--}}
...
{{--                    <td>{{$category->new_title}}</td>--}}
{{--                    <td>{{$category->new_content}}</td>--}}
{{--                                            <td><a href="{{url("/edit-category/{$category->id}")}}"class="btn btn-outline-dark">Them</a>--}}
{{--                                                <form action="{{url("/delete-category/{$category->id}")}}"method="post">--}}
{{--                                                    @method("DELETE")--}}
{{--                                                    @csrf--}}
{{--                                                    <button type="submit" onclick="return confirm('M chac chan chua')"class="btn btn-danger"DeLEte></button>--}}
{{--                                                </form>--}}
{{--                                            </td>--}}
{{--                </tr>--}}
{{--            @endforeach--}}
