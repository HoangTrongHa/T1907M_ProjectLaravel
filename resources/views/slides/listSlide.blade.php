                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($slide as $value)
                            <tr >
                                ...
                                <td>
                                    <img  src="{{asset('upload/slide')}}/{{$value->image}}" width="80px" alt="">
                                </td>
                                @if($value->status==1)
                                ...
                                <td>
                                    <a href="{{url("admin/slide/check/{$value->id}")}}" class="label bg-green">Check</a>
                                    <a href="{{url("admin/slide/edit/{$value->id}")}}" class="label bg-blue">Edit</a>
                                    <a href="{{url("admin/slide/delete/{$value->id}")}}" class="label bg-red">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
